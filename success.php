...
<div class="container bg-red-500 mb-20 pt-16 px-6 py-20">
  ...
  <div class="container px-5 py-10 mx-auto flex flex-wrap items-center bg-orange-400">
    ...
    <div class="lg:w-5/6 md:w-1/2 bg-yellow-500 rounded-lg p-20 flex flex-col md:ml-24 w-full mt-10 md:mt-0 pl-22 pr-22">
      ...
      <h2 class="text-gray-900 text-lg font-medium title-font mb-2 w-auto ml-0"><b>Booking Confirmation</b></h2>
       <h2 class="text-gray-900 text-lg font-medium title-font mb-2 w-auto ml-0"><b>Booking is Successfully Done.</b></h2>
       <h2 class="text-gray-900 text-lg font-medium title-font mb-2 w-auto ml-0"><b>You can View Your Booking status. Your Booking will confirm within 24 Hours.<br>
						To view the Current status <a href="Status.php"class="text-blue-800">Click Here</a></b></h2>
...
<footer class="text-gray-700 body-font">
  <div class="container px-5 py-2 mx-auto flex items-center sm:flex-row flex-col">
    ...
    <p class="text-sm text-black-800 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2020 SK Travels —
