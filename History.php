...
<!--Main Content-->
<div class="w-full md:w-4/5 bg-red-100">
...
<section class="text-black-700 body-font">
  <h1 class="fontsize-10">History:</h1>
  <div class="container">
    ...
    <div class="lg:w-3/3 w-full mx-auto overflow-auto">
      <table class="table-auto w-full text-left whitespace-no-wrap">
        ...
        $Status='pending';
        $query="select * from reservation where Login_Email='$Login_mail' ";
...
<ul class="list-reset flex flex-row md:flex-col text-center md:text-left">
   ...
   <!--  <h2 class="text-gray-300 m-5"><b>Welcome,Username</b></h2> -->
      ...
      <a href="CustomerDashboard.php" class="block py-1 md:py-3 pl-1 align-middle text-gray-800 no-underline hover:text-pink-500 border-b-2 border-gray-800 md:border-gray-900 hover:border-pink-500"> <i class="fas fa-link pr-0 md:pr-3"></i>
